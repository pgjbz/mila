...
;{}()[]!%"
    ...
    let tokens = vec![
        ...
        Token::new(
            TokenType::Asterisk,
            Location::new(1, 7, Rc::clone(&filename)),
            "*".to_string(),
        ),
        Token::new(
            TokenType::Greater,
        ...
        Token::new(
            TokenType::Pipe,
            Location::new(1, 16, Rc::clone(&filename)),
            "|".to_string(),
        ),
        Token::new(
            TokenType::Semicolon,
        ...
        Token::new(
            TokenType::Eof,
            Location::new(2, 10, Rc::clone(&filename)),
            "\0".to_string(),
        ),
    ];
...
#aaaa"
    ...
    let tokens = vec![
        ...
        Token::new(
            TokenType::Identifier,
            Location::new(3, 12, Rc::clone(&filename)),
            "mila_lang".to_string(),
        ),
        Token::new(
            TokenType::Identifier,
            Location::new(4, 1, Rc::clone(&filename)),
            "mila".to_string(),
        ),
        Token::new(
            TokenType::Dot,
        ...
        Token::new(
            TokenType::Illegal,
            Location::new(5, 1, Rc::clone(&filename)),
            "#aaaa".to_string(),
        ),
    ];
    test_tokens(lexer, &tokens)
...
1477a;"
    ...
    let tokens = vec![
        ...
        Token::new(
            TokenType::Number,
            Location::new(3, 8, Rc::clone(&filename)),
            "458444".to_string(),
        ),
        Token::new(
            TokenType::Pipe,
            Location::new(3, 14, Rc::clone(&filename)),
            "|".to_string(),
        ),
        Token::new(
            TokenType::Number,
        ...
        Token::new(
            TokenType::BitWiseAnd,
            Location::new(4, 7, Rc::clone(&filename)),
            "&".to_string(),
        ),
        Token::new(
            TokenType::Number,
        ...
        Token::new(
            TokenType::Caret,
            Location::new(5, 7, Rc::clone(&filename)),
            "^".to_string(),
        ),
        Token::new(
            TokenType::Number,
        ...
        Token::new(
            TokenType::Number,
            Location::new(6, 3, Rc::clone(&filename)),
            "2".to_string(),
        ),
        Token::new(
            TokenType::Illegal,
            Location::new(7, 1, Rc::clone(&filename)),
            "1477a".to_string(),
        ),
        Token::new(
            TokenType::Semicolon,
            Location::new(7, 6, Rc::clone(&filename)),
            ";".to_string(),
        ),
    ];
    test_tokens(lexer, &tokens);
...
fn test_word_token() {
    ...
    let tokens = vec![
        ...
        Token::new(
            TokenType::False,
            Location::new(1, 20, Rc::clone(&filename)),
            "false".to_string(),
        ),
        Token::new(
            TokenType::Fn,
            Location::new(1, 26, Rc::clone(&filename)),
            "fn".to_string(),
        ),
        Token::new(
            TokenType::Ret,
            Location::new(1, 29, Rc::clone(&filename)),
            "ret".to_string(),
        ),
    ];
    test_tokens(lexer, &tokens);
...
fn test_two_char_token() {
    ...
    let tokens = vec![
        ...
        Token::new(
            ...
            Location::new(1, 22, Rc::clone(&filename)),
            "-=".to_string(),
        ),
        Token::new(
        ...
        Token::new(
            TokenType::And,
            Location::new(1, 31, Rc::clone(&filename)),
            "&&".to_string(),
        ),
        Token::new(
            TokenType::Or,
            Location::new(1, 34, Rc::clone(&filename)),
            "||".to_string(),
        ),
    ];
    test_tokens(lexer, &tokens);
...
\"aaaaaa"
    ...
    let tokens = vec![
        ...
        Token::new(
            TokenType::Semicolon,
            Location::new(3, 2, Rc::clone(&filename)),
            ";".to_string(),
        ),
        Token::new(
            TokenType::Illegal,
